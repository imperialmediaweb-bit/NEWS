          ...
          <div className="prose prose-lg max-w-none" style={{ fontFamily: "'Source Serif 4', serif", lineHeight: 1.8 }}>
            ...
            <div style={{ background: "#f9f9f9", padding: "1rem 1.5rem", borderLeft: "4px solid var(--accent)", margin: "1rem 0" }}>
              <p style={{ margin: 0 }}>
                ...
                {site.name}<br />
                Visit our <Link href="/contact" className="text-[var(--accent)] underline">Contact Page</Link> with subject &quot;DMCA Notice — {site.name}&quot;
              </p>
            </div>
            ...
            <p>
              Visit our <Link href="/contact" className="text-[var(--accent)] underline">Contact Page</Link> and include &quot;DMCA Notice&quot; or &quot;DMCA Counter-Notification&quot; in your message.
            </p>
