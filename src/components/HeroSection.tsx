...
export default function HeroSection({ heroStory, sideStories }: HeroSectionProps) {
  return (
          ...
          <article className="group cursor-pointer">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8">
                <Badge className="mb-3">{heroStory.badge || "News"}</Badge>
                <h1
                ...
                <div className="flex items-center gap-4 text-gray-300 text-xs">
                  <span className="flex items-center gap-1">
                    <Clock className="w-3 h-3" /> {heroStory.time}
                  </span>
                  <span className="flex items-center gap-1">
                    <MessageSquare className="w-3 h-3" /> {(heroStory.comments || 0).toLocaleString()} comments
                  </span>
                  <span className="flex items-center gap-1">
