                ...
                >
                  <div className="relative overflow-hidden">
                    <img
                      ...
                      className="w-full h-[200px] md:h-[260px] object-cover group-hover:scale-105 transition-transform duration-500"
                    />
                  </div>
                  <h3
            ...
            <div className="space-y-3">
              {col.articles.slice(1).map((article, i) => (
                <Link key={i} href={articleHref(article)}>
                  ...
                  >
                    <img src={article.img} alt={article.title} className="w-[80px] h-[60px] md:w-[100px] md:h-[75px] object-cover shrink-0" />
